...
VALUES
  ...
  ('33333333-3333-4333-8333-333333333308', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', 'Grid Connection', 'GridConnection', 'OK', '{}')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('44444444-4444-4444-8444-444444444407', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', '33333333-3333-4333-8333-333333333308', '77777777-7777-4777-8777-777777777701', 'Grid Meter', 'grid_meter', 'simulated', 'simulated-grid-meter-driver', 'OK', now(), 'sim-1.0.0', 'placeholder')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('55555555-5555-4555-8555-555555555510', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', '33333333-3333-4333-8333-333333333308', '44444444-4444-4444-8444-444444444407', 'energy.grid.import.kw', 'Grid import', 'kW', 'OK', 'read', '{"watch_high": 20}'),
  ('55555555-5555-4555-8555-555555555511', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', '33333333-3333-4333-8333-333333333308', '44444444-4444-4444-8444-444444444407', 'energy.grid.export.kw', 'Grid export', 'kW', 'OK', 'read', '{}'),
  ('55555555-5555-4555-8555-555555555512', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', '33333333-3333-4333-8333-333333333308', '44444444-4444-4444-8444-444444444407', 'energy.consumption.kw', 'Site consumption', 'kW', 'OK', 'read', '{}'),
  ('55555555-5555-4555-8555-555555555513', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', '33333333-3333-4333-8333-333333333305', '44444444-4444-4444-8444-444444444405', 'agri.irrigation.command', 'Irrigation command', 'state', 'OK', 'write', '{"max_runtime_minutes": 120, "max_starts_per_day": 6}')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  (now() - interval '2 minutes', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', '33333333-3333-4333-8333-333333333308', '44444444-4444-4444-8444-444444444407', '55555555-5555-4555-8555-555555555510', 'energy.grid.import.kw', 3.2, 'kW', 'OK', 'simulator'),
  (now() - interval '2 minutes', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', '33333333-3333-4333-8333-333333333308', '44444444-4444-4444-8444-444444444407', '55555555-5555-4555-8555-555555555511', 'energy.grid.export.kw', 9.8, 'kW', 'OK', 'simulator'),
  (now() - interval '2 minutes', '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222201', '33333333-3333-4333-8333-333333333308', '44444444-4444-4444-8444-444444444407', '55555555-5555-4555-8555-555555555512', 'energy.consumption.kw', 12.0, 'kW', 'OK', 'simulator');
